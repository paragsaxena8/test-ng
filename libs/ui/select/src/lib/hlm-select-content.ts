...
import { BrnSelectContent, BrnSelectImports } from '@spartan-ng/brain/select';
...
@Component({
	...
	template: `
		<brn-select-content [class]="_computedClasses()">
			@if (showScroll()) {
				<brn-select-scroll-up />
			}
